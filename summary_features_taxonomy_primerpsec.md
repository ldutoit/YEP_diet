...
rm -r test
```
and then downloaded the file *sequencescephalo.fasta/dna-sequenceschordates.fasta* [metadata/featurescephalo.fasta](metadata/featurescephalo.fasta)/[metadata/featureschordates.fasta](metadata/featureschordates.fasta)


I then combined those 6 files as two using [feature_taxo_summary_primerspec.py]. 
